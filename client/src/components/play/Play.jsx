      ...
      <Box className={classes.main}>
        <Box className={classes.contentOne}>
          {token ? (
            ...
            <Button variant="contained" className={classes.addTodo} fullWidth>
          ...
          <Box overflow="auto" maxHeight={300} className={classes.todo}>
            {eventes?.map((event) => {
              return (
                <Box
                  key={event.id}
                  ...
                  className={
                    event._id === current ? classes.box : classes.boxOne
                  }
                >
                  <Typography variant="h5">{event.name}</Typography>
                  <Typography variant="body1">{event.teamId}</Typography>
                  <Box>
